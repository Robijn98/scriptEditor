...
//     CodeEditor* editor = currentEditor();
//     if (!editor) {
//         console->appendPlainText("Error: No active editor");
//         return;
//     }
...
//         if (!status) {
//             console->appendHtml("<span style='color:red;'>Error executing line.</span>");
//         } else {
//             // Read stdout
//             QFile fOut(outFile);
...
//                     console->appendPlainText(stdoutText.trimmed());
//             }
...
//                     console->appendHtml("<span style='color:red;'>" + stderrText.trimmed() + "</span>");
//             }
...
//                 fRet.close();
//                 if (!retText.isEmpty())
//                     console->appendHtml("<span style='color:green;'>Return: " + retText.trimmed() + "</span>");
//             }
...
//         console->appendPlainText("<span style='color:red;'>Error: No text selected</span>");
//         return;
//     }
